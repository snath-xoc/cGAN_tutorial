...
CLASSES = 4
DEFAULT_FCST_SHAPE = (121, 91, 2 * len(all_fcst_fields))
DEFAULT_CON_SHAPE = (121, 91, 2)
DEFAULT_OUT_SHAPE = (121, 91, 1)

lo_res_lat = np.arange(-6,6.1,0.1)
lo_res_lon = np.arange(33,42.1,0.1)
...
def write_data(
    ...
    img_chunk_width=32,  # controls size of subsampled image
    num_class=CLASSES,
    log_precip=True,
    fcst_norm=True,
    consolidated=False,
    ...
    # HArdcoded to only 24 hour set up
    for time_idx in np.arange(30,54,24):
